...
for i = 1:1%3:3%1:length(names)%patient2:1-35, patient4:36- ,patient6:
...
var11=(bp2+gp2+rp2)-(bd2+gd2+rd2);
var11(g~=0)=0;
var11=imadjust(var11,stretchlim(var11,[0.05 1-0.05]),[]);
var11=normalise(im2double(var11));
